    ...
    var _tab = {
        ...
        createTabDom: function() {
            ...
            var tpl = [
                    ...
                    '<li class="layui-this" lay-id="-1" data-url="' + _config.mainUrl + '"><i class="layui-icon">&#xe68e;</i>课堂中心</li>',
                    '</ul>',
            ...
            _toolBody.find('li.kit-item').each(function() {
                ...
                $(".layui-nav-tree li:nth-child(1)").find(".layui-nav-child").children("dd:first-child").addClass("layui-this");
